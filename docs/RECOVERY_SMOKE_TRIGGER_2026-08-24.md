...
This commit explicitly requests the extended isolated New Monday Excel recovery smoke test.
...
5. Confirm a Formula edit is rejected as a read-only recovery conflict.
